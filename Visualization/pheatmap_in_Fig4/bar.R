...
data <- read.table("strAB_all_coverage_0.9_0.8_chr.txt", header = T, check.names = F)

data$group <- factor(data$group,levels = c("A","B1","D","F","G"))
mycol <- c("#e4201e","#2c80c1","#8d8de3","#3ea75d","#e5842b")
